...
/**
 * @brief log data at repeating interval
 */
...
void write_log_data(TimerHandle_t timer) {
...
bool logger_init(){
    printf("logger init");
    BaseType_t status_task_pico = xTaskCreate(task_logger, "LOGGER_TASK",  2048, NULL, 1, &handle_task_pico);
    return ( status_task_pico == pdPASS );
}
